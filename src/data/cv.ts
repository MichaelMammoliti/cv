...
export const datesArray: DateRange[] = [
  { from: '2023-10-01T00:00:00.000Z', to: 'Present' },
  { from: '2023-04-01T00:00:00.000Z', to: '2023-10-01T00:00:00.000Z' },
...
export const experience: Experience[] = [
  {
    ...
    date: datesArray[0],
    description: [
      `led the development of custom experiences targeting major platforms including web, Fire TV and Alexa`,
      `built reusable components, video streaming and tracking solutions to be reused across Amazon Brand Stores`,
      `prototyped Augmented Reality and 3D experiences with Three.js, React Three Fiber, AR.js, MindAR and MediaPipe libraries`,
      `used local LLMs and Gen AI tools to automate processes, increase productivity and reduce management`,
      `created, reviewed and defined requirements to overcome technical/UI challenges`,
      `cross-functional collaboration and tech support between Designers, Engineers and Solution Managers`,
      `improved accessibility score across components and live pages to comply with EU regulations`,
      `showcased fully working prototypes and provided real time support to stakeholders`,
    ],
    skills: [
      'React',
      'Typescript',
