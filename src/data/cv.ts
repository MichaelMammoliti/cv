...
export const experience: Experience[] = [
  {
    ...
    date: datesArray[0],
    description: [
      `cross-functional collaboration and support between Designers, Engineers and Solution Managers`,
      `defined requirements and scoping winning strategies for technical/UI challenges and organisational processes`,
      `led the development of highly custom, responsive and accessible web solutions targeting major web platforms including Fire TV and Alexa`,
      `prototyped Augmented Reality experiences leveraging Generative AI and AWS`,
      `assesses and documented tools, libraries, components, onboarding processes and accessibility reports`,
      `developed internal tools to automate processes, increase productivity and reduce management`,
    ],
    skills: [
      'React',
      'Typescript',
